        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-tmc-primary">Loved by Students & Parents</h2>
             <p className="max-w-xl mx-auto text-lg text-tmc-text/80 mt-2">
              See what others are saying about The Math Catalyst.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            />
            <TestimonialCard
              quote="I was struggling with algebra, but the step-by-step explanations in the sessions made it all click."
              author="Lethu K."
              grade="Grade 9 Student (Grade 10-12)"
            />
          </div>
        </div>
      </section>
